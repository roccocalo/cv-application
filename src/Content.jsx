      ...
      <div className="flex flex-row justify-center bg-slate-200 items-center gap-24 py-10 px-40 ">
        <div className="bg-white rounded-xl h-fit p-4 w-2/5 ">   {/* form  */}
          ...
          <div className="flex justify-center mt-5">
            <ReactToPrint
              trigger={() => <button className="bg-sky-600 text-white text-xl rounded-lg py-2 px-4"><span className="flex gap-2 justify-center items-center"> <img className="w-5 mt-1" src="/Images/download.svg" alt="gith icon" />Download</span></button>}
